  ...
  return (
    <aside className="right-sidebar" data-testid="right-system-sidebar">
      ...
      <div className="panel-card" data-testid="document-summary-card">
        <p className="card-label" data-testid="document-summary-title">Archivio</p>
        <p className="card-value" data-testid="document-summary-total">{status?.documents_total ?? 0} documenti</p>
      ...
      <div className="panel-card" data-testid="model-status-card">
        <p className="card-label" data-testid="model-status-title">Modello locale</p>
        <p className="card-value" data-testid="model-status-value">{status?.active_model ?? '—'}</p>
      </div>
    </aside>
  );
};
